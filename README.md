...
Operation
Place the robot on a flat elevated surface
Ensure IR sensor is mounted facing downward at 30-45° angle
Power on the system using the battery switch
Robot will move forward until an edge is detected
Upon edge detection, robot will:
Stop immediately
Move backward
